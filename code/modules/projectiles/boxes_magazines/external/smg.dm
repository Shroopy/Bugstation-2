...
/obj/item/ammo_box/magazine/smartgun
	name = "smart SMG magazine (.160 Smart)" // BUG EDIT
...
/obj/item/ammo_box/magazine/uzim9mm
	name = "\improper lightweight SMG magazine (9mm)" // BUG EDIT
	desc = "A long 9mm magazine, suitable for lightweight submachine guns." // BUG EDIT
...
/obj/item/ammo_box/magazine/smgm9mm
	name = "\improper NT SMG magazine (9mm)" // BUG EDIT
	desc = "A sleek 9mm magazine, suitable for Nanotrasen's SABR SMG." // BUG EDIT
	icon_state = "smg9mm"
...
/obj/item/ammo_box/magazine/smgm9mm/ap
	name = "NT SMG magazine (9mm AP)" // BUG EDIT
	MAGAZINE_TYPE_ARMORPIERCE
	ammo_type = /obj/item/ammo_casing/c9mm/ap

/obj/item/ammo_box/magazine/smgm9mm/fire
	name = "NT SMG magazine (9mm incendiary)" // BUG EDIT
	MAGAZINE_TYPE_INCENDIARY
	ammo_type = /obj/item/ammo_casing/c9mm/fire

/obj/item/ammo_box/magazine/smgm45
	name = "SMG magazine (.45)"
	desc = "A long .45 magazine, suitable for the C-20r bullpup SMG." // BUG EDIT
	icon_state = "c20r45"
