...
/obj/item/tape/ruins/ancient_milsim/devlog_one
	...
	storedinfo = alist(
		...
		7 = "<span class='game say'><span class='name'>Leon Gardner</span> <span class='message'>warns, \"<span class=' '>This particular map, 'intro-underscore-two', is a shortened representation of the many covert SolGov operations launched around the first few months of the war.</span>\"</span></span>",
