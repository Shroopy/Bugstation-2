/obj/item/gun/energy/event_horizon
	name = "\improper anti-existential beam rifle" // BUG CHANGE (was "Event Horizon anti-existential beam rifle")
	desc = "The natural and horrifying conclusion to Nanotrasen's energy weapons armsrace. A platform which weaponizes black holes. You shudder even thinking about it." // BUG CHANGE (was "The deranged minds of Nanotrasen, in their great hubris and spite, have birthed forth the definitive conclusion to the arms race. Weaponized black holes, and a platform to deliver them. To look upon this existential maleficence is to know that the pursuit of profit has consigned all life to this pathetic conclusion; the destruction of reality itself.")
