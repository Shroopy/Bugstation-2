...
GLOBAL_LIST_INIT(rarity_loot, list(//rare: really good items
	...
	list(//misc
		// /obj/item/book/granter/crafting_recipe/dusting/pipegun_prime = 1, BUG REMOVAL
		/obj/item/book/granter/crafting_recipe/trash_cannon = 1,
		// /obj/item/book/granter/crafting_recipe/dusting/laser_musket_prime = 1, BUG REMOVAL
